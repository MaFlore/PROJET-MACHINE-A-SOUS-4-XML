...
function actualiserPage() {
    ...
    if (objet_xml_http_request.readyState == 4) {
        ...
        if (objet_xml_http_request.status == 200) {
            ...
            resultatXml = objet_xml_http_request.responseXML;

            console.log(resultatXml);

            var gainTxt = resultatXml.getElementsByTagName("gain")[0].firstChild.nodeValue;
            var niveauJoueurTxt = resultatXml.getElementsByTagName("niveau")[0].firstChild.nodeValue;
